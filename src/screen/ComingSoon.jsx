...
const ComingSoon = () => {
  ...
  return (
    <section className="w-full min-h-screen bg-white " x-data="{ isOpen: false }">
      <ScrollToTop />
        ...
        >
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-col mt-8 space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
              <input id="email" type="text" className="px-6 py-3 text-gray-700 bg-white border rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring sm:mx-2" placeholder="Email Address" />
